...
class BankAccountTest {
    ...
    @BeforeEach public void initialisation() {
        bankAccount = new BankAccount(new BigDecimal(5000), Collections.emptySet());
    }

    @Test public void should_deposit_money_and_create_operation() {
    ...
    @Test public void should_not_do_anything_when_amount_is_null() {
    ...
    @Test public void should_withdraw_money_and_create_operation() {
    ...
    @Test public void should_withdraw_when_amount_null() {
